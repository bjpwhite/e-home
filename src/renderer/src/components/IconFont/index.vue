...
<template>
  <div class="a-svg-container">
    <el-tooltip v-if="mode === 'tip'" effect="dark" :content="tip" placement="top">
      <span class="tip" :class="margin ? 'operation-margin' : ''" @click="iconClick" @blur="iconBlur">
        <svg class="icon" aria-hidden="true">
          <use :xlink:href="`#e-home-${iconName}`" />
        </svg>
      </span>
    </el-tooltip>
    <el-popconfirm v-else-if="mode === 'confirm'" :title="warning" confirm-button-type="primary" cancel-button-type="text" icon="el-icon-question" @confirm="iconConfirm">
