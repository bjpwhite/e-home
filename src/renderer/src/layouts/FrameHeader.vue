...
const minimizeBg = ref('')
const maximizeBg = ref('')
const dangerBg = ref('')
const stickBg = ref('')
...
<template>
  ...
  <div class="frame-header-container">
    <div class="frame-header-operation">
      ...
      >
        <icon-font icon-name="yanjing" class="sticky" />
      </div>
      <div
        class="frame-header-btn"
      ...
      >
        <icon-font :icon-name="isMaximized ? `fangdasuoxiao` : `fangda`" />
      </div>
      <div
        class="frame-header-btn"
      ...
      >
        <icon-font icon-name="guanbi" :style="{ color: dangerBg ? '#fff' : '' }" />
      </div>
    </div>
    <div class="clear" />
  </div>
